@php
    ...
    // Refrescar el record para obtener los totales actualizados
    $record->refresh();
...
@if($record)
<div style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-radius: 12px; padding: 16px;">
