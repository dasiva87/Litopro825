                ...
                <div style="position: relative; flex: 0 0 calc(33.333% - 0.5rem); max-width: calc(33.333% - 0.5rem); border-radius: 0.75rem; border: 2px solid #e5e7eb; background-color: white; overflow: hidden; transition: all 0.2s;">
                    ...
                    <div style="background: linear-gradient(to right, #f9fafb, white); padding: 0.75rem 1rem; border-bottom: 1px solid #e5e7eb;">
                        <div style="display: flex; align-items: center; justify-content: space-between; gap: 0.5rem;">
                            ...
                            <div style="display: flex; align-items: center; gap: 0.75rem; flex: 1; min-width: 0;">
                                ...
                                @else
                                    <div style="height: 2.5rem; width: 2.5rem; border-radius: 0.5rem; background: linear-gradient(to bottom right, #10b981, #059669); display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 1rem; box-shadow: 0 4px 6px rgba(0,0,0,0.1); flex-shrink: 0;">
                    ...
                    <div style="padding: 0.75rem 1rem; display: flex; flex-direction: column; gap: 0.5rem;">
                        ...
                        <button
                            ...
                            type="button"
                            style="display: inline-flex; align-items: center; justify-content: center; gap: 0.375rem; width: 100%; padding: 0.5rem 0.75rem; font-size: 0.875rem; font-weight: 500; color: white; background-color: #10b981; border-radius: 0.5rem; border: none; cursor: pointer; transition: background-color 0.2s;"
                            onmouseover="this.style.backgroundColor='#059669'"
                            onmouseout="this.style.backgroundColor='#10b981'"
                        >
                            <x-filament::icon icon="heroicon-m-paper-airplane" class="h-4 w-4" style="width: 1rem; height: 1rem;" />
                            Solicitar como Cliente
                        </button>
                    </div>
                </div>
            @endforeach
